...
import UpdateAttendance from "./UpdateAttendanceComponent";
  ...
  render() {
    return (
      <div className="container">
          ...
          <li class="nav-item">
            <div className="dropdown">
              ...
              <div className="dropdown-content">
                ...
                <Link onClick={this.updateAttendanceHandler}>
        ...
        {this.state.updateAttendance ? (
          <UpdateAttendance data1={this.state.userData.mentorId} />
        ) : null}
      </div>
    );
  }
